...
import first from './building/Borough-Market-the-Shard-and-the-Pub-_.jpg';
import second from './building/building-3215255_640.jpg';
import eye from './building/logosss/eye.png';
import share from './building/logosss/hre.png';
import love from './building/logosss/lov.png';
import cmnt from './building/logosss/cmnt.png';
import cont from './building/logosss/pro.png';
        ...
        <div className="buttonbigcontain">
          ...
          <div className="infibeambackground">
            ...
            <div className="comment1">
              <img width="25px" src={cont} alt="" />
              <h4 className="commentallfontfam" >Lorem ipsum</h4>
              <button className="sectorbuttonnew">Sector 1</button>
              </div>
